...
//   const handleClick = () => {
//     if (!location) return;
//     setTriggerFetch(prev => prev + 1); // Increment to trigger fetch
//   };
...
//       <div className="bg-amber-300 p-2 flex flex-row gap-10 justify-center">
//         <h1 className="lg:text-2xl text-sm font-bold flex items-center left-5">
//           Weather App
//         </h1>
//         <input
//           type="text"
...
//           className="rounded px-2 py-2 bg-white"
//         />
//         <button
//           onClick={handleClick}
//           className="bg-amber-500 text-white lg:p-2 sm:p-1 lg:text-sm sm:text-sm rounded cursor-pointer px-3 hover:bg-amber-200"
//         >
//           Get Weather
//         </button>
//       </div>
